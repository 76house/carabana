"""
Django settings for carabana project.
...
SECRET_KEY = 'django-insecure-889$h!@g)k@w8d*k%cazx6icrk&hu+&qr0409&h8zg@+fu-#uq'
...
WSGI_APPLICATION = 'carabana.wsgi.application'
